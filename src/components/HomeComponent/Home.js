        ...
        <section className='hero'>
            ...
            <div id="footer">
                <footer>
                    ...
                    <span><a href="https://github.com/Francis-Adjei/FinalCapStoneProject"><i className="fa fa-github" aria-hidden="true"></i></a><a href="https://www.linkedin.com/in/adjei-francis-91a40016b/"><i className="fa fa-linkedin" aria-hidden="true"></i></a></span>
                </footer>
            </div>
        </section>
    )
